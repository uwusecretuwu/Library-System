...
public class heheheh extends JPanel implements ActionListener
{
    ...
    public heheheh()
    {
        ...
        lblbooktitle.setFont(new Font("Times New Roman", Font.ITALIC, 20));
        ...
        txtcontact.setFont(new Font("Times New Roman", Font.ITALIC, 20));
...
=======
    ...
    public void actionPerformed(ActionEvent e) 
    {
     ...
     if(e.getSource() == btnadd) 
     {
        ...
        txtname.setText("");
        txtcontact.setText("");
>>>>>>> branch 'master' of ssh://git@github.com/uwusecretuwu/Project-o.git
